...
public class PermutationTables {
    public static int[] initialKeyPermutation = {57, 49, 41, 33, 25, 17, 9, 1,
    ...
    public static int[] rightFinalPermutation = {16, 7, 20, 21, 29, 12, 28, 17,
            1, 15, 23, 26, 5, 18, 31, 10,
            2, 8, 24, 14, 32, 27, 3, 9, 19,
            13, 30, 6, 22, 11, 4, 25};

    public static int[][] getshrinkPermutationBlock(int id) throws Exception {
        switch (id){
            case 0: {
                return shrinkPermutationBlock1;
            }
            case 1: {
                return shrinkPermutationBlock2;
            }
            case 2: {
                return shrinkPermutationBlock3;
            }
            case 3: {
                return shrinkPermutationBlock4;
            }
            case 4: {
                return shrinkPermutationBlock5;
            }
            case 5: {
                return shrinkPermutationBlock6;
            }
            case 6: {
                return shrinkPermutationBlock7;
            }
            case 7: {
                return shrinkPermutationBlock8;
            }
        }
